...
public class rvAdapter extends RecyclerView.Adapter<rvAdapter.ViewHolder> {
    ...
    public rvAdapter(List<pokemon> pokemonList, Context context) {
        ...
        database1 = new sqlDatabase(this.context);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.abilityList.addItemDecoration(itemDecoration);
        holder.abilityList.setLayoutManager(new LinearLayoutManager(context));
        holder.abilityList.setAdapter(arrayAdapter1);
